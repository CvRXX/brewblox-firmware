...
// optional bool bitfield = 10;
inline bool BrewBlox_testFieldOptions::_internal_has_bitfield() const {
...
inline bool BrewBlox_testFieldOptions::_internal_bitfield() const {
  return bitfield_;
}
...
inline void BrewBlox_testFieldOptions::_internal_set_bitfield(bool value) {
  _has_bits_[0] |= 0x00000200u;
  bitfield_ = value;
}
