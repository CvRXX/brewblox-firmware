...
constexpr BlockType BlockType_MAX = OneWireGpioModule;
...
class MessageOpts PROTOBUF_FINAL :
 ...
 public:
  ...
  inline MessageOpts* New() const final {
    return CreateMaybeMessage<MessageOpts>(nullptr);
  }

  MessageOpts* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_brewblox_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class FieldOpts PROTOBUF_FINAL :
 ...
 public:
  ...
  inline FieldOpts* New() const final {
    return CreateMaybeMessage<FieldOpts>(nullptr);
  }

  FieldOpts* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 MessageOpts::_internal_subtype() const {
  return subtype_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 MessageOpts::subtype() const {
  // @@protoc_insertion_point(field_get:brewblox.MessageOpts.subtype)
  return _internal_subtype();
}
inline void MessageOpts::_internal_set_subtype(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  subtype_ = value;
}
inline void MessageOpts::set_subtype(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 FieldOpts::_internal_scale() const {
  return scale_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 FieldOpts::scale() const {
  // @@protoc_insertion_point(field_get:brewblox.FieldOpts.scale)
  return _internal_scale();
}
inline void FieldOpts::_internal_set_scale(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  scale_ = value;
}
inline void FieldOpts::set_scale(::PROTOBUF_NAMESPACE_ID::uint32 value) {
