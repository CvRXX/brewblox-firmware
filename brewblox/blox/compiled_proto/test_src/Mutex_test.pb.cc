...
static void InitDefaultsscc_info_Block_Mutex_5ftest_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Block_Mutex_5ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Block_Mutex_5ftest_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::blox_test::Mutex::_Block_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Mutex_5ftest_2eproto_sccs[1] = {
  &scc_info_Block_Mutex_5ftest_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Mutex_5ftest_2eproto = {
  false, false, descriptor_table_protodef_Mutex_5ftest_2eproto, "Mutex_test.proto", 202,
  &descriptor_table_Mutex_5ftest_2eproto_once, descriptor_table_Mutex_5ftest_2eproto_sccs, descriptor_table_Mutex_5ftest_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_Mutex_5ftest_2eproto::offsets,
  file_level_metadata_Mutex_5ftest_2eproto, 1, file_level_enum_descriptors_Mutex_5ftest_2eproto, file_level_service_descriptors_Mutex_5ftest_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Mutex_5ftest_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Mutex_5ftest_2eproto)), true);
namespace blox_test {
namespace Mutex {
...
const Block& Block::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Block_Mutex_5ftest_2eproto.base);
...
template<> PROTOBUF_NOINLINE ::blox_test::Mutex::Block* Arena::CreateMaybeMessage< ::blox_test::Mutex::Block >(Arena* arena) {
