...
enum ChannelId : int {
  ...
  ChannelId_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ChannelId_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class Block PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_Spark3Pins_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::_internal_voltage5() const {
  return voltage5_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::voltage5() const {
  // @@protoc_insertion_point(field_get:blox_test.Spark3Pins.Block.voltage5)
  return _internal_voltage5();
}
inline void Block::_internal_set_voltage5(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  voltage5_ = value;
}
inline void Block::set_voltage5(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::_internal_voltage12() const {
  return voltage12_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::voltage12() const {
  // @@protoc_insertion_point(field_get:blox_test.Spark3Pins.Block.voltage12)
  return _internal_voltage12();
}
inline void Block::_internal_set_voltage12(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  voltage12_ = value;
}
inline void Block::set_voltage12(::PROTOBUF_NAMESPACE_ID::uint32 value) {
