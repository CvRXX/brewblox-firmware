...
constexpr ChannelId ChannelId_MIN = DS2413_CHAN_NONE;
constexpr ChannelId ChannelId_MAX = DS2413_CHAN_B;
...
class Block PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:blox_test.DS2413.Block) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_DS2413_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
