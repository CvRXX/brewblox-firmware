...
enum PinConnectMode : int {
  CONNECT_VALVE = 0,
  CONNECT_ACTUATOR = 1,
  PinConnectMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  PinConnectMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
inline bool PinConnectMode_Parse(
    const std::string& name, PinConnectMode* value) {
...
class Block PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_DS2408_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
