...
enum Calibrated : int {
  ...
  CALIBRATED_YES = 1,
  CALIBRATED_NEW = 2,
  Calibrated_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Calibrated_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class Block PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_TouchSettings_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Block::_internal_xoffset() const {
  return xoffset_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Block::xoffset() const {
  // @@protoc_insertion_point(field_get:blox_test.TouchSettings.Block.xOffset)
  return _internal_xoffset();
}
inline void Block::_internal_set_xoffset(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  xoffset_ = value;
}
inline void Block::set_xoffset(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Block::_internal_yoffset() const {
  return yoffset_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Block::yoffset() const {
  // @@protoc_insertion_point(field_get:blox_test.TouchSettings.Block.yOffset)
  return _internal_yoffset();
}
inline void Block::_internal_set_yoffset(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  yoffset_ = value;
}
inline void Block::set_yoffset(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::_internal_xbitsperpixelx16() const {
  return xbitsperpixelx16_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::xbitsperpixelx16() const {
  // @@protoc_insertion_point(field_get:blox_test.TouchSettings.Block.xBitsPerPixelX16)
  return _internal_xbitsperpixelx16();
}
inline void Block::_internal_set_xbitsperpixelx16(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  xbitsperpixelx16_ = value;
}
inline void Block::set_xbitsperpixelx16(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::_internal_ybitsperpixelx16() const {
  return ybitsperpixelx16_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::ybitsperpixelx16() const {
  // @@protoc_insertion_point(field_get:blox_test.TouchSettings.Block.yBitsPerPixelX16)
  return _internal_ybitsperpixelx16();
}
inline void Block::_internal_set_ybitsperpixelx16(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  ybitsperpixelx16_ = value;
}
inline void Block::set_ybitsperpixelx16(::PROTOBUF_NAMESPACE_ID::uint32 value) {
