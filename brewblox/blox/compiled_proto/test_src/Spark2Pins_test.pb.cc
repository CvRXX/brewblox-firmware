...
static void InitDefaultsscc_info_Block_Spark2Pins_5ftest_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Block_Spark2Pins_5ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Block_Spark2Pins_5ftest_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::blox_test::Spark2Pins::_Block_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Spark2Pins_5ftest_2eproto_sccs[1] = {
  &scc_info_Block_Spark2Pins_5ftest_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Spark2Pins_5ftest_2eproto = {
  false, false, descriptor_table_protodef_Spark2Pins_5ftest_2eproto, "Spark2Pins_test.proto", 503,
  &descriptor_table_Spark2Pins_5ftest_2eproto_once, descriptor_table_Spark2Pins_5ftest_2eproto_sccs, descriptor_table_Spark2Pins_5ftest_2eproto_deps, 1, 3,
  schemas, file_default_instances, TableStruct_Spark2Pins_5ftest_2eproto::offsets,
  file_level_metadata_Spark2Pins_5ftest_2eproto, 1, file_level_enum_descriptors_Spark2Pins_5ftest_2eproto, file_level_service_descriptors_Spark2Pins_5ftest_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Spark2Pins_5ftest_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Spark2Pins_5ftest_2eproto)), true);
namespace blox_test {
namespace Spark2Pins {
...
void Block::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Block_Spark2Pins_5ftest_2eproto.base);
...
template<> PROTOBUF_NOINLINE ::blox_test::Spark2Pins::Block* Arena::CreateMaybeMessage< ::blox_test::Spark2Pins::Block >(Arena* arena) {
