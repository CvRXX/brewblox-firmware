...
enum ValveState : int {
  ...
  VALVE_INIT_IDLE = 6,
  ValveState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ValveState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class Block PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_MotorValve_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::_internal_startchannel() const {
  return startchannel_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::startchannel() const {
  // @@protoc_insertion_point(field_get:blox_test.MotorValve.Block.startChannel)
  return _internal_startchannel();
}
inline void Block::_internal_set_startchannel(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  startchannel_ = value;
}
inline void Block::set_startchannel(::PROTOBUF_NAMESPACE_ID::uint32 value) {
