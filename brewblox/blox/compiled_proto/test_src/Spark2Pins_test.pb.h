...
enum Hardware : int {
  ...
  HW_SPARK1 = 1,
  HW_SPARK2 = 2,
  Hardware_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Hardware_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class Block PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_Spark2Pins_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
