...
static void InitDefaultsscc_info_Block_ActuatorAnalogMock_5ftest_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Block_ActuatorAnalogMock_5ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Block_ActuatorAnalogMock_5ftest_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ActuatorAnalogMock_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, setting_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, value_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, minsetting_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, maxsetting_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, minvalue_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, maxvalue_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, constrainedby_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, desiredsetting_),
  PROTOBUF_FIELD_OFFSET(::blox_test::ActuatorAnalogMock::Block, strippedfields_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::blox_test::ActuatorAnalogMock::_Block_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ActuatorAnalogMock_5ftest_2eproto_sccs[1] = {
  &scc_info_Block_ActuatorAnalogMock_5ftest_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ActuatorAnalogMock_5ftest_2eproto = {
  false, false, descriptor_table_protodef_ActuatorAnalogMock_5ftest_2eproto, "ActuatorAnalogMock_test.proto", 531,
  &descriptor_table_ActuatorAnalogMock_5ftest_2eproto_once, descriptor_table_ActuatorAnalogMock_5ftest_2eproto_sccs, descriptor_table_ActuatorAnalogMock_5ftest_2eproto_deps, 1, 3,
  schemas, file_default_instances, TableStruct_ActuatorAnalogMock_5ftest_2eproto::offsets,
  file_level_metadata_ActuatorAnalogMock_5ftest_2eproto, 1, file_level_enum_descriptors_ActuatorAnalogMock_5ftest_2eproto, file_level_service_descriptors_ActuatorAnalogMock_5ftest_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ActuatorAnalogMock_5ftest_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ActuatorAnalogMock_5ftest_2eproto)), true);
namespace blox_test {
namespace ActuatorAnalogMock {
...
Block::Block(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:blox_test.ActuatorAnalogMock.Block)
}
...
void Block::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Block_ActuatorAnalogMock_5ftest_2eproto.base);
...
template<> PROTOBUF_NOINLINE ::blox_test::ActuatorAnalogMock::Block* Arena::CreateMaybeMessage< ::blox_test::ActuatorAnalogMock::Block >(Arena* arena) {
  return Arena::CreateMessageInternal< ::blox_test::ActuatorAnalogMock::Block >(arena);
}
