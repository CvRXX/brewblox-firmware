...
class IoChannel PROTOBUF_FINAL :
 ...
 public:
  ...
  inline IoChannel* New() const final {
    return CreateMaybeMessage<IoChannel>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_IoArray_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 IoChannel::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 IoChannel::id() const {
  // @@protoc_insertion_point(field_get:blox_test.IoArray.IoChannel.id)
  return _internal_id();
}
inline void IoChannel::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void IoChannel::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
