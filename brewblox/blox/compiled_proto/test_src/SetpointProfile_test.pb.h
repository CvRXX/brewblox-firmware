...
class Point PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_SetpointProfile_5ftest_2eproto);
    return ::descriptor_table_SetpointProfile_5ftest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::_internal_start() const {
  return start_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Block::start() const {
  // @@protoc_insertion_point(field_get:blox_test.SetpointProfile.Block.start)
  return _internal_start();
}
inline void Block::_internal_set_start(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  start_ = value;
}
inline void Block::set_start(::PROTOBUF_NAMESPACE_ID::uint32 value) {
