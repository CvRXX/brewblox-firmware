...
static ::_pb::Metadata file_level_metadata_DS2408_5ftest_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_DS2408_5ftest_2eproto[2];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_DS2408_5ftest_2eproto = nullptr;

const uint32_t TableStruct_DS2408_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::blox_test::DS2408::Block)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::blox_test::DS2408::_Block_default_instance_._instance,
};
...
const char descriptor_table_protodef_DS2408_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_DS2408_5ftest_2eproto_deps[3] = {
  &::descriptor_table_IoArray_5ftest_2eproto,
  &::descriptor_table_brewblox_5ftest_2eproto,
  &::descriptor_table_nanopb_5ftest_2eproto,
};
static ::_pbi::once_flag descriptor_table_DS2408_5ftest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_DS2408_5ftest_2eproto = {
    false, false, 693, descriptor_table_protodef_DS2408_5ftest_2eproto,
    "DS2408_test.proto",
    ...
    file_level_metadata_DS2408_5ftest_2eproto, file_level_enum_descriptors_DS2408_5ftest_2eproto,
    file_level_service_descriptors_DS2408_5ftest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_DS2408_5ftest_2eproto_getter() {
  return &descriptor_table_DS2408_5ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_DS2408_5ftest_2eproto(&descriptor_table_DS2408_5ftest_2eproto);
namespace blox_test {
namespace DS2408 {
...
uint8_t* Block::_InternalSerialize(
  ...
  if (this->_internal_onewirebusid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(10, this->_internal_onewirebusid(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:blox_test.DS2408.Block)
  ...
  if (this->_internal_connectmode() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_connectmode());
  }
...
template<> PROTOBUF_NOINLINE ::blox_test::DS2408::Block*
Arena::CreateMaybeMessage< ::blox_test::DS2408::Block >(Arena* arena) {
