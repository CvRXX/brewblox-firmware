...
enum SensorCombiFunc : int {
  ...
  SensorCombiFunc_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SensorCombiFunc_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class Block final :
 ...
 public:
  ...
  void clear_sensors();
  private:
  uint32_t _internal_sensors(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_sensors() const;
  void _internal_add_sensors(uint32_t value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > sensors_;
...
inline uint32_t Block::_internal_sensors(int index) const {
  return sensors_.Get(index);
}
inline uint32_t Block::sensors(int index) const {
  // @@protoc_insertion_point(field_get:blox_test.TempSensorCombi.Block.sensors)
  return _internal_sensors(index);
}
inline void Block::set_sensors(int index, uint32_t value) {
  sensors_.Set(index, value);
  // @@protoc_insertion_point(field_set:blox_test.TempSensorCombi.Block.sensors)
}
inline void Block::_internal_add_sensors(uint32_t value) {
  sensors_.Add(value);
}
inline void Block::add_sensors(uint32_t value) {
