...
class Block final :
 ...
 public:
  ...
  int32_t minsetting() const;
  void set_minsetting(int32_t value);
  private:
  int32_t _internal_minsetting() const;
  void _internal_set_minsetting(int32_t value);
  public:

  // sint32 maxSetting = 5 [(.nanopb) = {
  void clear_maxsetting();
  int32_t maxsetting() const;
  void set_maxsetting(int32_t value);
  private:
  int32_t _internal_maxsetting() const;
  void _internal_set_maxsetting(int32_t value);
  public:
...
inline int32_t Block::_internal_minsetting() const {
  return minsetting_;
}
inline int32_t Block::minsetting() const {
  // @@protoc_insertion_point(field_get:blox_test.ActuatorAnalogMock.Block.minSetting)
  return _internal_minsetting();
}
inline void Block::_internal_set_minsetting(int32_t value) {
  
  minsetting_ = value;
}
inline void Block::set_minsetting(int32_t value) {
...
inline int32_t Block::_internal_maxsetting() const {
  return maxsetting_;
}
inline int32_t Block::maxsetting() const {
  // @@protoc_insertion_point(field_get:blox_test.ActuatorAnalogMock.Block.maxSetting)
  return _internal_maxsetting();
}
inline void Block::_internal_set_maxsetting(int32_t value) {
  
  maxsetting_ = value;
}
inline void Block::set_maxsetting(int32_t value) {
...
inline int32_t Block::_internal_minvalue() const {
  return minvalue_;
}
inline int32_t Block::minvalue() const {
  // @@protoc_insertion_point(field_get:blox_test.ActuatorAnalogMock.Block.minValue)
  return _internal_minvalue();
}
inline void Block::_internal_set_minvalue(int32_t value) {
  
  minvalue_ = value;
}
inline void Block::set_minvalue(int32_t value) {
...
inline int32_t Block::_internal_maxvalue() const {
  return maxvalue_;
}
inline int32_t Block::maxvalue() const {
  // @@protoc_insertion_point(field_get:blox_test.ActuatorAnalogMock.Block.maxValue)
  return _internal_maxvalue();
}
inline void Block::_internal_set_maxvalue(int32_t value) {
  
  maxvalue_ = value;
}
inline void Block::set_maxvalue(int32_t value) {
