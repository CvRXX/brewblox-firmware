...
enum ValveState : int {
  ...
  VALVE_INIT_IDLE = 6,
  ValveState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ValveState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool ValveState_IsValid(int value);
constexpr ValveState ValveState_MIN = VALVE_UNKNOWN;
constexpr ValveState ValveState_MAX = VALVE_INIT_IDLE;
constexpr int ValveState_ARRAYSIZE = ValveState_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ValveState_descriptor();
template<typename T>
inline const std::string& ValveState_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ValveState>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ValveState_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ValveState_descriptor(), enum_t_value);
}
inline bool ValveState_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ValveState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ValveState>(
    ValveState_descriptor(), name, value);
}
// ===================================================================

class Block final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:blox_test.MotorValve.Block) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "blox_test.MotorValve.Block";
  }
  protected:
  ...
  uint32_t startchannel() const;
  void set_startchannel(uint32_t value);
  private:
  uint32_t _internal_startchannel() const;
  void _internal_set_startchannel(uint32_t value);
  public:
  ...
  private:
  ::blox_test::MotorValve::ValveState _internal_valvestate() const;
  void _internal_set_valvestate(::blox_test::MotorValve::ValveState value);
  public:
...
inline uint32_t Block::_internal_startchannel() const {
  return startchannel_;
}
inline uint32_t Block::startchannel() const {
  // @@protoc_insertion_point(field_get:blox_test.MotorValve.Block.startChannel)
  return _internal_startchannel();
}
inline void Block::_internal_set_startchannel(uint32_t value) {
  
  startchannel_ = value;
}
inline void Block::set_startchannel(uint32_t value) {
...
inline void Block::unsafe_arena_set_allocated_constrainedby(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:blox_test.MotorValve.Block.constrainedBy)
}
...
inline ::blox_test::MotorValve::ValveState Block::_internal_valvestate() const {
...
inline void Block::_internal_set_valvestate(::blox_test::MotorValve::ValveState value) {
