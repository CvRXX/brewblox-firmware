...
static ::_pb::Metadata file_level_metadata_nanopb_5ftest_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_nanopb_5ftest_2eproto[2];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_nanopb_5ftest_2eproto = nullptr;

const uint32_t TableStruct_nanopb_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_nanopb_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_nanopb_5ftest_2eproto_deps[1] = {
  &::descriptor_table_google_2fprotobuf_2fdescriptor_2eproto,
};
static ::_pbi::once_flag descriptor_table_nanopb_5ftest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_nanopb_5ftest_2eproto = {
    false, false, 959, descriptor_table_protodef_nanopb_5ftest_2eproto,
    "nanopb_test.proto",
    ...
    file_level_metadata_nanopb_5ftest_2eproto, file_level_enum_descriptors_nanopb_5ftest_2eproto,
    file_level_service_descriptors_nanopb_5ftest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_nanopb_5ftest_2eproto_getter() {
  return &descriptor_table_nanopb_5ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_nanopb_5ftest_2eproto(&descriptor_table_nanopb_5ftest_2eproto);
