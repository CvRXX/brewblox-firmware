...
static ::_pb::Metadata file_level_metadata_DigitalActuator_5ftest_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_DigitalActuator_5ftest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_DigitalActuator_5ftest_2eproto = nullptr;

const uint32_t TableStruct_DigitalActuator_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::blox_test::DigitalActuator::Block)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::blox_test::DigitalActuator::_Block_default_instance_._instance,
};
...
const char descriptor_table_protodef_DigitalActuator_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "o3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_DigitalActuator_5ftest_2eproto_deps[4] = {
  &::descriptor_table_Constraints_5ftest_2eproto,
  &::descriptor_table_IoArray_5ftest_2eproto,
  &::descriptor_table_brewblox_5ftest_2eproto,
  &::descriptor_table_nanopb_5ftest_2eproto,
};
static ::_pbi::once_flag descriptor_table_DigitalActuator_5ftest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_DigitalActuator_5ftest_2eproto = {
    false, false, 482, descriptor_table_protodef_DigitalActuator_5ftest_2eproto,
    "DigitalActuator_test.proto",
    ...
    file_level_metadata_DigitalActuator_5ftest_2eproto, file_level_enum_descriptors_DigitalActuator_5ftest_2eproto,
    file_level_service_descriptors_DigitalActuator_5ftest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_DigitalActuator_5ftest_2eproto_getter() {
  return &descriptor_table_DigitalActuator_5ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_DigitalActuator_5ftest_2eproto(&descriptor_table_DigitalActuator_5ftest_2eproto);
namespace blox_test {
namespace DigitalActuator {
...
uint8_t* Block::_InternalSerialize(
  ...
  if (this->_internal_invert() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(4, this->_internal_invert(), target);
  }
...
template<> PROTOBUF_NOINLINE ::blox_test::DigitalActuator::Block*
Arena::CreateMaybeMessage< ::blox_test::DigitalActuator::Block >(Arena* arena) {
