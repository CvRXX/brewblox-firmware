...
static ::_pb::Metadata file_level_metadata_Spark2Pins_5ftest_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_Spark2Pins_5ftest_2eproto[2];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Spark2Pins_5ftest_2eproto = nullptr;

const uint32_t TableStruct_Spark2Pins_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::blox_test::Spark2Pins::Block, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::blox_test::Spark2Pins::Block, soundalarm_),
  PROTOBUF_FIELD_OFFSET(::blox_test::Spark2Pins::Block, hardware_),
  PROTOBUF_FIELD_OFFSET(::blox_test::Spark2Pins::Block, channels_),
  PROTOBUF_FIELD_OFFSET(::blox_test::Spark2Pins::Block, pins_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::blox_test::Spark2Pins::Block)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::blox_test::Spark2Pins::_Block_default_instance_._instance,
};
...
const char descriptor_table_protodef_Spark2Pins_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_Spark2Pins_5ftest_2eproto_deps[3] = {
  &::descriptor_table_IoArray_5ftest_2eproto,
  &::descriptor_table_brewblox_5ftest_2eproto,
  &::descriptor_table_nanopb_5ftest_2eproto,
};
static ::_pbi::once_flag descriptor_table_Spark2Pins_5ftest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Spark2Pins_5ftest_2eproto = {
    false, false, 503, descriptor_table_protodef_Spark2Pins_5ftest_2eproto,
    "Spark2Pins_test.proto",
    ...
    file_level_metadata_Spark2Pins_5ftest_2eproto, file_level_enum_descriptors_Spark2Pins_5ftest_2eproto,
    file_level_service_descriptors_Spark2Pins_5ftest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_Spark2Pins_5ftest_2eproto_getter() {
  return &descriptor_table_Spark2Pins_5ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_Spark2Pins_5ftest_2eproto(&descriptor_table_Spark2Pins_5ftest_2eproto);
namespace blox_test {
namespace Spark2Pins {
...
Block::Block(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  channels_(arena) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:blox_test.Spark2Pins.Block)
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&hardware_) - reinterpret_cast<char*>(this)),
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          ...
          CHK_(ptr);
          _internal_set_hardware(static_cast<::blox_test::Spark2Pins::Hardware>(val));
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:blox_test.Spark2Pins.Block)
  ...
  if (this->_internal_hardware() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_hardware());
  }
...
void Block::InternalSwap(Block* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      + sizeof(Block::pins_)
      - PROTOBUF_FIELD_OFFSET(Block, hardware_)>(
          reinterpret_cast<char*>(&hardware_),
          reinterpret_cast<char*>(&other->hardware_));
}
...
template<> PROTOBUF_NOINLINE ::blox_test::Spark2Pins::Block*
Arena::CreateMaybeMessage< ::blox_test::Spark2Pins::Block >(Arena* arena) {
  return Arena::CreateMessageInternal< ::blox_test::Spark2Pins::Block >(arena);
}
