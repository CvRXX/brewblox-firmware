...
static OtaParameters otaParameters;
...
static void ota_task(void* pvParameter)
{
    ...
    esp_http_client_config_t config = {
        .url = otaParameters.url,
        .cert_pem = nullptr, // (char *)server_cert_pem_start,
        .timeout_ms = 5000,
        ...
        if (data_read < 0) {
            ...
            if (image_header_was_checked == false) {
                ...
                if (data_read > sizeof(esp_image_header_t) + sizeof(esp_image_segment_header_t) + sizeof(esp_app_desc_t)) {
                    ...
                    if (!otaParameters.skip_version_check && memcmp(new_app_info.version, running_app_info.version, sizeof(new_app_info.version)) == 0) {
