...
void WidgetWrapper::setName(std::string&& newName)
{
    auto txt = newName;
    D4D_SetText(&btnObject, txt.c_str());
}

void WidgetWrapper::setColor(uint8_t r, uint8_t g, uint8_t b)
{
    colorScheme = makeSmallColorScheme(r, g, b);
}

void WidgetWrapper::resetName()
{
    D4D_SetText(&btnObject, "unassigned");
}

void WidgetWrapper::setClickHandler(void* obj, void (*func)(void*))
{
    clickHandlerFunction = func;
    clickHandlerObject = obj;
}

void WidgetWrapper::resetClickHandler()
{
    clickHandlerFunction = nullptr;
    clickHandlerObject = nullptr;
}

void WidgetWrapper::addChildren(std::vector<D4D_OBJECT*>&& children)
{
...
void WidgetWrapper::resetChildren()
{
...
void WidgetWrapper::invalidate()
{
    D4D_InvalidateObject(&wrapperObject, D4D_FALSE);
}

void WidgetWrapper::setEnabled(bool enabled)
{
