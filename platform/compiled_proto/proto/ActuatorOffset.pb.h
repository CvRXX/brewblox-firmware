...
#define blox_ActuatorOffset_Block_init_default   {0, 0, _blox_ActuatorOffset_ReferenceKind_MIN, 0, 0, blox_Constraints_AnalogConstraints_init_default, 0, 0, 0, 0, {0, 0}}
#define blox_ActuatorOffset_Block_init_zero      {0, 0, _blox_ActuatorOffset_ReferenceKind_MIN, 0, 0, blox_Constraints_AnalogConstraints_init_zero, 0, 0, 0, 0, {0, 0}}
...
#define blox_ActuatorOffset_Block_strippedFields_tag 99

/* Struct field encoding specification for nanopb */
extern const pb_field_t blox_ActuatorOffset_Block_fields[11];

/* Maximum encoded size of messages (where known) */
#define blox_ActuatorOffset_Block_size           257
