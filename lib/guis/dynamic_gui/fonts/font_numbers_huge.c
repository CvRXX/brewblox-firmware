 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --format lvgl --size 80 --font RobotoMono-Medium.ttf -r 0x20,0x25,0xB0,0x43,0x46,0x2D,0x30-0x39,0x2E -o font_numbers_huge.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 12554, .adv_w = 768, .box_w = 42, .box_h = 59, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 13793, .adv_w = 768, .box_w = 38, .box_h = 57, .ofs_x = 6, .ofs_y = 0},
    {.bitmap_index = 14876, .adv_w = 768, .box_w = 21, .box_h = 21, .ofs_x = 14, .ofs_y = 37}
};
