...
typedef enum _blox_Sequence_SequenceStatus {
    ...
    blox_Sequence_SequenceStatus_WAIT = 4,
...
typedef struct _blox_Sequence_TargetProfile {
    uint16_t target;
/* @@protoc_insertion_point(struct:blox_Sequence_TargetProfile) */
} blox_Sequence_TargetProfile;

typedef struct _blox_Sequence_TargetSequence {
    uint16_t target;
/* @@protoc_insertion_point(struct:blox_Sequence_TargetSequence) */
} blox_Sequence_TargetSequence;
...
typedef struct _blox_Sequence_WaitTemperatureRange {
    uint16_t target;
    int32_t lower;
    int32_t upper;
/* @@protoc_insertion_point(struct:blox_Sequence_WaitTemperatureRange) */
} blox_Sequence_WaitTemperatureRange;
...
typedef struct _blox_Sequence_Instruction {
    ...
    union {
        ...
        blox_Sequence_WaitTemperatureRange WAIT_TEMP_BETWEEN;
        blox_Sequence_WaitTemperatureRange WAIT_TEMP_NOT_BETWEEN;
        blox_Sequence_WaitTemperatureRange WAIT_TEMP_UNEXPECTED;
        blox_Sequence_WaitTemperatureBoundary WAIT_TEMP_ABOVE;
        blox_Sequence_WaitTemperatureBoundary WAIT_TEMP_BELOW;
        ...
        blox_Sequence_TargetProfile START_PROFILE;
        blox_Sequence_TargetProfile WAIT_PROFILE;
        blox_Sequence_TargetSequence START_SEQUENCE;
        blox_Sequence_TargetSequence WAIT_SEQUENCE;
    } instruction_oneof;
...
#define blox_Sequence_WaitTemperatureRange_init_default {0, 0, 0}
...
#define blox_Sequence_TargetProfile_init_default {0}
#define blox_Sequence_TargetSequence_init_default {0}
...
#define blox_Sequence_WaitTemperatureRange_init_zero {0, 0, 0}
...
#define blox_Sequence_TargetProfile_init_zero    {0}
#define blox_Sequence_TargetSequence_init_zero   {0}
...
#define blox_Sequence_TargetProfile_target_tag   1
#define blox_Sequence_TargetSequence_target_tag  1
...
#define blox_Sequence_WaitTemperatureRange_target_tag 1
#define blox_Sequence_WaitTemperatureRange_lower_tag 2
#define blox_Sequence_WaitTemperatureRange_upper_tag 3
...
#define blox_Sequence_Instruction_WAIT_TEMP_BETWEEN_tag 6
#define blox_Sequence_Instruction_WAIT_TEMP_NOT_BETWEEN_tag 7
#define blox_Sequence_Instruction_WAIT_TEMP_UNEXPECTED_tag 8
#define blox_Sequence_Instruction_WAIT_TEMP_ABOVE_tag 9
#define blox_Sequence_Instruction_WAIT_TEMP_BELOW_tag 10
#define blox_Sequence_Instruction_SET_SETPOINT_tag 11
#define blox_Sequence_Instruction_WAIT_SETPOINT_tag 12
#define blox_Sequence_Instruction_SET_DIGITAL_tag 13
#define blox_Sequence_Instruction_WAIT_DIGITAL_tag 14
#define blox_Sequence_Instruction_SET_PWM_tag    15
#define blox_Sequence_Instruction_START_PROFILE_tag 16
#define blox_Sequence_Instruction_WAIT_PROFILE_tag 17
#define blox_Sequence_Instruction_START_SEQUENCE_tag 18
#define blox_Sequence_Instruction_WAIT_SEQUENCE_tag 19
...
extern const pb_field_t blox_Sequence_WaitTemperatureRange_fields[4];
...
extern const pb_field_t blox_Sequence_TargetProfile_fields[2];
extern const pb_field_t blox_Sequence_TargetSequence_fields[2];
extern const pb_field_t blox_Sequence_Instruction_fields[20];
...
#define blox_Sequence_WaitTemperatureRange_size  18
...
#define blox_Sequence_TargetProfile_size         6
#define blox_Sequence_TargetSequence_size        6
