...
const pb_field_t blox_Sequence_WaitTemperatureRange_fields[4] = {
    PB_FIELD(  1, UINT32  , SINGULAR, STATIC  , FIRST, blox_Sequence_WaitTemperatureRange, target, target, 0),
    PB_FIELD(  2, SINT32  , SINGULAR, STATIC  , OTHER, blox_Sequence_WaitTemperatureRange, lower, target, 0),
    PB_FIELD(  3, SINT32  , SINGULAR, STATIC  , OTHER, blox_Sequence_WaitTemperatureRange, upper, lower, 0),
    PB_LAST_FIELD
};
...
const pb_field_t blox_Sequence_TargetProfile_fields[2] = {
    PB_FIELD(  1, UINT32  , SINGULAR, STATIC  , FIRST, blox_Sequence_TargetProfile, target, target, 0),
    PB_LAST_FIELD
};

const pb_field_t blox_Sequence_TargetSequence_fields[2] = {
    PB_FIELD(  1, UINT32  , SINGULAR, STATIC  , FIRST, blox_Sequence_TargetSequence, target, target, 0),
    PB_LAST_FIELD
};

const pb_field_t blox_Sequence_Instruction_fields[20] = {
    ...
    PB_ONEOF_FIELD(instruction_oneof,   6, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_TEMP_BETWEEN, WAIT_TEMP_BETWEEN, &blox_Sequence_WaitTemperatureRange_fields),
    PB_ONEOF_FIELD(instruction_oneof,   7, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_TEMP_NOT_BETWEEN, WAIT_TEMP_NOT_BETWEEN, &blox_Sequence_WaitTemperatureRange_fields),
    PB_ONEOF_FIELD(instruction_oneof,   8, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_TEMP_UNEXPECTED, WAIT_TEMP_UNEXPECTED, &blox_Sequence_WaitTemperatureRange_fields),
    PB_ONEOF_FIELD(instruction_oneof,   9, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_TEMP_ABOVE, WAIT_TEMP_ABOVE, &blox_Sequence_WaitTemperatureBoundary_fields),
    PB_ONEOF_FIELD(instruction_oneof,  10, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_TEMP_BELOW, WAIT_TEMP_BELOW, &blox_Sequence_WaitTemperatureBoundary_fields),
    PB_ONEOF_FIELD(instruction_oneof,  11, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, SET_SETPOINT, SET_SETPOINT, &blox_Sequence_SetSetpoint_fields),
    PB_ONEOF_FIELD(instruction_oneof,  12, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_SETPOINT, WAIT_SETPOINT, &blox_Sequence_WaitSetpoint_fields),
    PB_ONEOF_FIELD(instruction_oneof,  13, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, SET_DIGITAL, SET_DIGITAL, &blox_Sequence_SetDigital_fields),
    PB_ONEOF_FIELD(instruction_oneof,  14, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_DIGITAL, WAIT_DIGITAL, &blox_Sequence_WaitDigital_fields),
    PB_ONEOF_FIELD(instruction_oneof,  15, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, SET_PWM, SET_PWM, &blox_Sequence_SetPwm_fields),
    PB_ONEOF_FIELD(instruction_oneof,  16, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, START_PROFILE, START_PROFILE, &blox_Sequence_TargetProfile_fields),
    PB_ONEOF_FIELD(instruction_oneof,  17, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_PROFILE, WAIT_PROFILE, &blox_Sequence_TargetProfile_fields),
    PB_ONEOF_FIELD(instruction_oneof,  18, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, START_SEQUENCE, START_SEQUENCE, &blox_Sequence_TargetSequence_fields),
    PB_ONEOF_FIELD(instruction_oneof,  19, MESSAGE , ONEOF, STATIC  , UNION, blox_Sequence_Instruction, WAIT_SEQUENCE, WAIT_SEQUENCE, &blox_Sequence_TargetSequence_fields),
    PB_LAST_FIELD
};
...
const pb_field_t blox_Sequence_Block_fields[10] = {
    ...
    PB_FIELD(  3, BOOL    , SINGULAR, STATIC  , OTHER, blox_Sequence_Block, overrideState, instructions, 0),
    PB_FIELD(  4, UINT32  , SINGULAR, STATIC  , OTHER, blox_Sequence_Block, activeInstruction, overrideState, 0),
