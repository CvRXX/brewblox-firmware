...
const pb_field_t blox_MotorValve_Block_fields[8] = {
    ...
    PB_FIELD(  2, UINT32  , SINGULAR, STATIC  , OTHER, blox_MotorValve_Block, channel, hwDevice, 0),
    PB_FIELD(  3, UENUM   , SINGULAR, STATIC  , OTHER, blox_MotorValve_Block, state, channel, 0),
    ...
    PB_FIELD(  8, UINT32  , SINGULAR, STATIC  , OTHER, blox_MotorValve_Block, claimedBy, desiredState, 0),
    PB_LAST_FIELD
};
