...
const pb_field_t blox_SetpointSensorPair_Block_fields[10] = {
    ...
    PB_FIELD(  7, BOOL    , SINGULAR, STATIC  , OTHER, blox_SetpointSensorPair_Block, enabled, value, 0),
    PB_FIELD(  8, SINT32  , SINGULAR, STATIC  , OTHER, blox_SetpointSensorPair_Block, storedSetting, enabled, 0),
