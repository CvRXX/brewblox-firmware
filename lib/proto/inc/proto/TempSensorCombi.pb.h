...
#define blox_TempSensorCombi_Block_init_default  {0, _blox_TempSensorCombi_SensorCombiFunc_MIN, 0, {0, 0, 0, 0, 0, 0, 0, 0}}
#define blox_TempSensorCombi_Block_init_zero     {0, _blox_TempSensorCombi_SensorCombiFunc_MIN, 0, {0, 0, 0, 0, 0, 0, 0, 0}}
...
extern const pb_field_t blox_TempSensorCombi_Block_fields[4];

/* Maximum encoded size of messages (where known) */
#define blox_TempSensorCombi_Block_size          56
