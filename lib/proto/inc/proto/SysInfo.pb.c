...
const pb_field_t blox_SysInfo_Block_fields[13] = {
    ...
    PB_FIELD( 12, UINT32  , SINGULAR, STATIC  , OTHER, blox_SysInfo_Block, systemTime, uptime, 0),
    PB_FIELD( 13, STRING  , SINGULAR, STATIC  , OTHER, blox_SysInfo_Block, timeZone, systemTime, 0),
    PB_FIELD( 14, UENUM   , SINGULAR, STATIC  , OTHER, blox_SysInfo_Block, tempUnit, timeZone, 0),
    PB_FIELD( 15, UINT32  , SINGULAR, STATIC  , OTHER, blox_SysInfo_Block, displayBrightness, tempUnit, 0),
    PB_LAST_FIELD
};
