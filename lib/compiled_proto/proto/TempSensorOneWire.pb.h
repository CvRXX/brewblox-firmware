...
#define blox_TempSensorOneWire_Block_init_default {0, 0, 0, 0, 0, {0}}
#define blox_TempSensorOneWire_Block_init_zero   {0, 0, 0, 0, 0, {0}}
...
#define blox_TempSensorOneWire_Block_strippedFields_tag 99

/* Struct field encoding specification for nanopb */
extern const pb_field_t blox_TempSensorOneWire_Block_fields[6];

/* Maximum encoded size of messages (where known) */
#define blox_TempSensorOneWire_Block_size        35
